...
#define MS_RTP_RECV_GENERIC_CN_RECEIVED		MS_FILTER_EVENT(MS_RTP_RECV_ID,0,const MSCngData*)
...
#define MS_RTP_SEND_SEND_STUN_MESSAGE	MS_FILTER_METHOD(MS_RTP_SEND_ID,7,const MSStunMsg*)
