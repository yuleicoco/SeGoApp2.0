 ...
 */
MS2_PUBLIC void ice_check_list_process(IceCheckList* cl, RtpSession* rtp_session);
 ...
 * This function is called from the audiostream or the videostream and is NOT to be called by the user.
 */
MS2_PUBLIC void ice_handle_stun_packet(IceCheckList* cl, RtpSession* rtp_session, const OrtpEventData* evt_data);

MS2_PUBLIC void ice_handle_stun_packet_reflect(RtpSession *rtp_session, const OrtpEventData *evt_data);
...
// 发送sip消息
MS2_PUBLIC void ice_send_sip_message(const RtpSession *rtp_session, const char* message);
