...
bool_t ORTP_PUBLIC ortp_getaddrname(addrname_t *name, const struct sockaddr* addr, socklen_t addrlen);
uint32_t ORTP_PUBLIC ortp_getblockid(const char *buffer, int size);
